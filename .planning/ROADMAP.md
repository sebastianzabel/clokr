...
- [ ] 01-02-PLAN.md — Fix Docker seed compilation for pnpm@10 + Prisma 7 (AUDIT-03)
- [ ] 01-03-PLAN.md — Add Playwright storageState setup project (TEST-02)
...
| ------------------------------ | -------------- | ----------- | --------- |
| 1. Test Infrastructure         | 0/6            | Not started | -         |
