 ...
 * code only — `__tests__/` and `*.test.ts` are skipped) whose delegate is one of the 45 models in
 ...
 * closed 45-model / 14-op vocabulary, so a receiver chain that merely CONTAINS one of those words
