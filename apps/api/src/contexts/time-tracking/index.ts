 ...
 * internal module.
 *
 * Empty today (`export {}` below) — this context's facade arrives in waves 4-5, plans 100B-08 and
 * 100B-09. The implementation will live in `./facade/`, never in this file directly: this file is
 * a PURE re-export surface and must contain no Prisma call, because it deliberately sits outside
 ...
 * mechanically once this context's facade exists.
 *
