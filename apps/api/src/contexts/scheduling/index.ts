 ...
 * internal module.
 *
 * Empty today (`export {}` below) — this context's facade arrives in wave 2, plan 100B-05. The
 * implementation will live in `./facade/`, never in this file directly: this file is a PURE
