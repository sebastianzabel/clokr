...
import { authRoutes } from "./contexts/unterbau/api/auth";
...
import { auditPlugin } from "./contexts/unterbau/plugins/audit";
import { prismaPlugin } from "./contexts/unterbau/plugins/prisma";
import { mailerPlugin } from "./contexts/unterbau/plugins/mailer";
import { notifyPlugin } from "./contexts/unterbau/plugins/notify";
import { schedulerPlugin } from "./contexts/schichtplanung/plugins/scheduler";
import { attendanceCheckerPlugin } from "./contexts/zeiterfassung/plugins/attendance-checker";
import { carryoverWarningPlugin } from "./contexts/abwesenheiten/plugins/carryover-warning";
import { dataRetentionPlugin } from "./contexts/unterbau/plugins/data-retention";
...
import { invitationRoutes } from "./contexts/unterbau/api/invitations";
import { auditLogRoutes } from "./contexts/unterbau/api/audit-logs";
import { activityRoutes } from "./contexts/unterbau/api/activity";
import { companyShutdownRoutes } from "./contexts/abwesenheiten/api/company-shutdowns";
...
import { vocationalSchoolPatternRoutes } from "./contexts/abwesenheiten/api/vocational-school-pattern";
import { vocationalSchoolRoutes } from "./contexts/abwesenheiten/api/vocational-school";
...
import { importRoutes } from "./contexts/unterbau/api/imports";
import { terminalRoutes } from "./contexts/zeiterfassung/api/terminals";
import { specialLeaveRoutes } from "./contexts/abwesenheiten/api/special-leave";
import { avatarRoutes } from "./contexts/unterbau/api/avatars";
import { section9DocumentRoutes } from "./contexts/abwesenheiten/api/section9-documents";
import { apiKeyRoutes } from "./contexts/unterbau/api/api-keys";
import { presenceRoutes } from "./contexts/zeiterfassung/api/presence";
import { adminPresenceSourcesRoutes } from "./contexts/zeiterfassung/api/admin-presence-sources";
import { adminSchoolHolidaysRoutes } from "./contexts/unterbau/api/admin/school-holidays";
import { meRoutes } from "./contexts/unterbau/api/me";
import { releaseNotesRoutes } from "./contexts/unterbau/api/release-notes";
import { testBootstrapRoutes } from "./contexts/unterbau/api/test-bootstrap";
import { retroEntryRequestRoutes } from "./contexts/zeiterfassung/api/retro-entry-requests";
