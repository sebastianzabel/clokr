...
import { mailerPlugin } from "./contexts/platform/plugins/mailer";
import { notifyPlugin } from "./contexts/platform/plugins/notify";
...
import { vocationalSchoolPatternRoutes } from "./contexts/absence/api/vocational-school-pattern";
import { vocationalSchoolRoutes } from "./contexts/absence/api/vocational-school";
import { availabilityRoutes } from "./contexts/scheduling/api/availability";
import { integrationRoutes } from "./contexts/scheduling/api/integrations";
import { importRoutes } from "./contexts/platform/api/imports";
import { terminalRoutes } from "./contexts/time-tracking/api/terminals";
