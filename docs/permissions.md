...
| `composition/dashboard.ts:1047`                            | Die Rolle wird nur in eine lokale Variable gelesen; die Entscheidung fällt in der nächsten Zeile :1048 und ist dort gezählt.                                                                                                                     |
