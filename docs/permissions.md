...
| `contexts/platform/api/employees.ts:275`                   | `GET /`                                         | A, M    | `employee:read`                | ZUGEWIESEN                                   |
| `contexts/platform/api/employees.ts:350`                   | `POST /`                                        | A       | `employee:create`              | ZUGEWIESEN                                   |
| `contexts/platform/api/employees.ts:601`                   | `PATCH /:id`                                    | A       | `employee:update`              | ZUGEWIESEN                                   |
| `contexts/platform/api/employees.ts:867`                   | `PATCH /:id/unlock`                             | A       | `employee:manage-access`       | ZUGEWIESEN                                   |
| `contexts/platform/api/employees.ts:906`                   | `PATCH /:id/deactivate`                         | A       | `employee:manage-access`       | ZUGEWIESEN                                   |
| `contexts/platform/api/employees.ts:965`                   | `PATCH /:id/reactivate`                         | A       | `employee:manage-access`       | ZUGEWIESEN                                   |
| `contexts/platform/api/employees.ts:1026`                  | `POST /:id/resend-invitation`                   | A       | `employee:manage-access`       | ZUGEWIESEN                                   |
| `contexts/platform/api/employees.ts:1086`                  | `DELETE /:id`                                   | A       | `employee:anonymize`           | ZUGEWIESEN                                   |
| `contexts/platform/api/employees.ts:1174`                  | `POST /:id/hard-delete/authorize`               | A       | `employee:anonymize`           | ZUGEWIESEN                                   |
| `contexts/platform/api/employees.ts:1205`                  | `DELETE /:id/hard-delete`                       | A       | `employee:anonymize`           | ZUGEWIESEN                                   |
...
| `contexts/platform/api/imports.ts:77`                      | `POST /employees`                               | A       | `employee:import`              | ZUGEWIESEN                                   |
| `contexts/platform/api/imports.ts:231`                     | `POST /time-entries`                            | A       | `time-entry:import`            | ZUGEWIESEN                                   |
...
| `contexts/platform/api/employees.ts:285`                 | `GET /`                                           | nur A: Anonymisierte einblenden               | `employee:anonymize`     | ZUGEWIESEN               |
| `contexts/platform/api/employees.ts:322`                 | `GET /:id`                                        | A, M: alle; E: nur eigene                     | `employee:read`          | ZUGEWIESEN; sonst EIGENE |
...
| `contexts/platform/api/employees.ts:686`                   | Die Rolle wird hier gesetzt, nicht geprüft; künftig `role-assignment:manage`, die Route selbst ist über :601 erfasst.        |
...
- **Vier-Augen-Regel bei der endgültigen Löschung** — `contexts/platform/api/employees.ts:1168`
