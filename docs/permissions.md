...
| `contexts/absence/api/leave.ts:980`                        | `PATCH /requests/:id/review`                    | A, M    | `leave-request:approve`        | ZUGEWIESEN                                   |
| `contexts/absence/api/leave.ts:1776`                       | `PATCH /requests/:id/correct`                   | A, M    | `leave-request:correct`        | ZUGEWIESEN                                   |
| `contexts/absence/api/leave.ts:2185`                       | `PATCH /requests/:id/attest`                    | A, M    | `leave-request:attest`         | ZUGEWIESEN                                   |
| `contexts/absence/api/leave.ts:2621`                       | `GET /ical/team`                                | A, M    | `leave-request:read`           | ZUGEWIESEN                                   |
| `contexts/absence/api/leave.ts:3043`                       | `POST /section9/:id/confirm`                    | A, M    | `section9:decide`              | ZUGEWIESEN                                   |
| `contexts/absence/api/leave.ts:3306`                       | `POST /section9/:id/reject`                     | A, M    | `section9:decide`              | ZUGEWIESEN                                   |
| `contexts/absence/api/leave.ts:3384`                       | `POST /section9/:id/reopen`                     | A, M    | `section9:decide`              | ZUGEWIESEN                                   |
...
| `contexts/time-tracking/api/retro-entry-requests.ts:186`   | `GET /`                                         | A, M    | `retro-request:read`           | ZUGEWIESEN                                   |
...
| `contexts/absence/api/leave.ts:799`                      | `GET /requests`                       | A, M: alle; E: nur eigene                     | `leave-request:read`     | ZUGEWIESEN; sonst EIGENE                 |
| `contexts/absence/api/leave.ts:962`                      | `GET /overlap`                        | A, M: Art sichtbar; E: Art verborgen          | `leave-request:read`     | ZUGEWIESEN; sonst EIGENE                 |
| `contexts/absence/api/leave.ts:2137`                     | `DELETE /requests/:id`                | A, M: alle; E: nur eigene                     | `leave-request:cancel`   | ZUGEWIESEN; sonst EIGENE                 |
| `contexts/absence/api/leave.ts:2362`                     | `GET /calendar`                       | A, M: Art sichtbar; E: nur bei eigenem Antrag | `leave-request:read`     | ZUGEWIESEN; sonst EIGENE                 |
| `contexts/absence/api/leave.ts:2712`                     | `GET /entitlements/:employeeId`       | A, M: alle; E: nur eigene                     | `leave-entitlement:read` | ZUGEWIESEN; sonst EIGENE                 |
| `contexts/absence/api/leave.ts:2898`                     | `GET /section9`                       | A, M: alle; E: nur eigene                     | `section9:read`          | ZUGEWIESEN; sonst EIGENE                 |
| `contexts/absence/api/leave.ts:2962`                     | `GET /section9/:id`                   | A, M: alle; E: nur eigene                     | `section9:read`          | ZUGEWIESEN; sonst EIGENE                 |
...
| `contexts/absence/api/leave.ts:741`                | Die Rolle des Antragstellers wird in den Audit-Eintrag geschrieben; keine Zugriffsentscheidung.                                                                                                                                                                                                                                                         |
...
- **Keine Selbstgenehmigung von Zeitnachträgen** —
  `contexts/time-tracking/api/retro-entry-requests.ts:260`: dieselbe Sperre für Zeitnachträge.
