...
| `contexts/platform/api/employees.ts:911`                   | `PATCH /:id/unlock`                             | A       | `employee:manage-access`       | ZUGEWIESEN                                   |
| `contexts/platform/api/employees.ts:950`                   | `PATCH /:id/deactivate`                         | A       | `employee:manage-access`       | ZUGEWIESEN                                   |
| `contexts/platform/api/employees.ts:1025`                  | `PATCH /:id/reactivate`                         | A       | `employee:manage-access`       | ZUGEWIESEN                                   |
| `contexts/platform/api/employees.ts:1086`                  | `POST /:id/resend-invitation`                   | A       | `employee:manage-access`       | ZUGEWIESEN                                   |
| `contexts/platform/api/employees.ts:1146`                  | `DELETE /:id`                                   | A       | `employee:anonymize`           | ZUGEWIESEN                                   |
| `contexts/platform/api/employees.ts:1257`                  | `POST /:id/hard-delete/authorize`               | A       | `employee:anonymize`           | ZUGEWIESEN                                   |
| `contexts/platform/api/employees.ts:1288`                  | `DELETE /:id/hard-delete`                       | A       | `employee:anonymize`           | ZUGEWIESEN                                   |
...
| `contexts/platform/api/employees.ts:325`                 | `GET /`                                           | nur A: Anonymisierte einblenden               | `employee:anonymize`     | ZUGEWIESEN                               |
| `contexts/platform/api/employees.ts:362`                 | `GET /:id`                                        | A, M: alle; E: nur eigene                     | `employee:read`          | ZUGEWIESEN; sonst EIGENE                 |
...
- **Vier-Augen-Regel bei der endgültigen Löschung** — `contexts/platform/api/employees.ts:1252`
  (Freigabe durch einen Administrator) und `:1336` (die Löschung prüft, dass die Freigabe von einem
