...
| `composition/dashboard.ts:1445`                            | `GET /overtime-trend`                           | A, M    | `overtime:read`                | ZUGEWIESEN                                   |
