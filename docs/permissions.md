...
| `composition/activity.ts:212`                            | `GET /`                                           | nur M: Team-Ereignisse                        | `team-overview:read`     | ZUGEWIESEN; Vorrang hat `audit-log:read` |
