...
| `contexts/absence/api/leave.ts:971`                        | `PATCH /requests/:id/review`                    | A, M    | `leave-request:approve`        | ZUGEWIESEN                                   |
| `contexts/absence/api/leave.ts:1753`                       | `PATCH /requests/:id/correct`                   | A, M    | `leave-request:correct`        | ZUGEWIESEN                                   |
| `contexts/absence/api/leave.ts:2162`                       | `PATCH /requests/:id/attest`                    | A, M    | `leave-request:attest`         | ZUGEWIESEN                                   |
| `contexts/absence/api/leave.ts:2598`                       | `GET /ical/team`                                | A, M    | `leave-request:read`           | ZUGEWIESEN                                   |
| `contexts/absence/api/leave.ts:3020`                       | `POST /section9/:id/confirm`                    | A, M    | `section9:decide`              | ZUGEWIESEN                                   |
| `contexts/absence/api/leave.ts:3283`                       | `POST /section9/:id/reject`                     | A, M    | `section9:decide`              | ZUGEWIESEN                                   |
| `contexts/absence/api/leave.ts:3361`                       | `POST /section9/:id/reopen`                     | A, M    | `section9:decide`              | ZUGEWIESEN                                   |
...
| `contexts/platform/api/employees.ts:364`                   | `GET /`                                         | A, M    | `employee:read`                | ZUGEWIESEN                                   |
| `contexts/platform/api/employees.ts:445`                   | `POST /`                                        | A       | `employee:create`              | ZUGEWIESEN                                   |
| `contexts/platform/api/employees.ts:696`                   | `PATCH /:id`                                    | A       | `employee:update`              | ZUGEWIESEN                                   |
| `contexts/platform/api/employees.ts:990`                   | `PATCH /:id/unlock`                             | A       | `employee:manage-access`       | ZUGEWIESEN                                   |
| `contexts/platform/api/employees.ts:1029`                  | `PATCH /:id/deactivate`                         | A       | `employee:manage-access`       | ZUGEWIESEN                                   |
| `contexts/platform/api/employees.ts:1104`                  | `PATCH /:id/reactivate`                         | A       | `employee:manage-access`       | ZUGEWIESEN                                   |
| `contexts/platform/api/employees.ts:1165`                  | `POST /:id/resend-invitation`                   | A       | `employee:manage-access`       | ZUGEWIESEN                                   |
| `contexts/platform/api/employees.ts:1225`                  | `DELETE /:id`                                   | A       | `employee:anonymize`           | ZUGEWIESEN                                   |
| `contexts/platform/api/employees.ts:1336`                  | `POST /:id/hard-delete/authorize`               | A       | `employee:anonymize`           | ZUGEWIESEN                                   |
| `contexts/platform/api/employees.ts:1367`                  | `DELETE /:id/hard-delete`                       | A       | `employee:anonymize`           | ZUGEWIESEN                                   |
...
| `contexts/time-tracking/api/retro-entry-requests.ts:181`   | `GET /`                                         | A, M    | `retro-request:read`           | ZUGEWIESEN                                   |
...
| `contexts/time-tracking/api/time-entries.ts:1872`          | `PATCH /:id/revalidate`                         | A, M    | `time-entry:revalidate`        | ZUGEWIESEN                                   |
...
| `contexts/absence/api/leave.ts:356`                      | `POST /requests`                      | A, M: auch für andere; E: nur für sich        | `leave-request:create`   | ZUGEWIESEN; sonst EIGENE                 |
| `contexts/absence/api/leave.ts:790`                      | `GET /requests`                       | A, M: alle; E: nur eigene                     | `leave-request:read`     | ZUGEWIESEN; sonst EIGENE                 |
| `contexts/absence/api/leave.ts:953`                      | `GET /overlap`                        | A, M: Art sichtbar; E: Art verborgen          | `leave-request:read`     | ZUGEWIESEN; sonst EIGENE                 |
| `contexts/absence/api/leave.ts:2114`                     | `DELETE /requests/:id`                | A, M: alle; E: nur eigene                     | `leave-request:cancel`   | ZUGEWIESEN; sonst EIGENE                 |
| `contexts/absence/api/leave.ts:2339`                     | `GET /calendar`                       | A, M: Art sichtbar; E: nur bei eigenem Antrag | `leave-request:read`     | ZUGEWIESEN; sonst EIGENE                 |
| `contexts/absence/api/leave.ts:2689`                     | `GET /entitlements/:employeeId`       | A, M: alle; E: nur eigene                     | `leave-entitlement:read` | ZUGEWIESEN; sonst EIGENE                 |
| `contexts/absence/api/leave.ts:2875`                     | `GET /section9`                       | A, M: alle; E: nur eigene                     | `section9:read`          | ZUGEWIESEN; sonst EIGENE                 |
| `contexts/absence/api/leave.ts:2939`                     | `GET /section9/:id`                   | A, M: alle; E: nur eigene                     | `section9:read`          | ZUGEWIESEN; sonst EIGENE                 |
...
| `contexts/platform/api/employees.ts:374`                 | `GET /`                               | nur A: Anonymisierte einblenden               | `employee:anonymize`     | ZUGEWIESEN                               |
| `contexts/platform/api/employees.ts:411`                 | `GET /:id`                            | A, M: alle; E: nur eigene                     | `employee:read`          | ZUGEWIESEN; sonst EIGENE                 |
| `contexts/platform/api/employees.ts:708`                 | `PATCH /:id`                          | nur A: Rolle setzen                           | `role-assignment:manage` | ZUGEWIESEN                               |
...
| `contexts/time-tracking/api/retro-entry-requests.ts:97`  | `POST /`                              | A, M: auch für andere; E: nur für sich        | `retro-request:create`   | ZUGEWIESEN; sonst EIGENE                 |
| `contexts/time-tracking/api/retro-entry-requests.ts:270` | `PATCH /:id/review`                   | nur A, M                                      | `retro-request:approve`  | ZUGEWIESEN                               |
...
| `contexts/time-tracking/api/time-entries.ts:1418`        | `PUT /:id`                            | A, M: alle; E: nur eigene                     | `time-entry:update`      | ZUGEWIESEN; sonst EIGENE                 |
| `contexts/time-tracking/api/time-entries.ts:1974`        | `DELETE /:id`                         | A, M: alle; E: nur eigene                     | `time-entry:delete`      | ZUGEWIESEN; sonst EIGENE                 |
| `contexts/time-tracking/api/time-entries.ts:2086`        | `PATCH /:id/break-status`             | A, M: alle; E: nur eigene                     | `time-entry:update`      | ZUGEWIESEN; sonst EIGENE                 |
...
- **Keine Selbstgenehmigung von Zeitnachträgen** —
  `contexts/time-tracking/api/retro-entry-requests.ts:258`: dieselbe Sperre für Zeitnachträge.
